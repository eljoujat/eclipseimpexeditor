...
import org.eclipseplugins.impexeditor.formatter.EclipseCodeStyleFormatter;
 ...
 */
public class FormatFile implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			EclipseCodeStyleFormatter eclipseCodeStyleFormatter=new EclipseCodeStyleFormatter();
			String formatted = eclipseCodeStyleFormatter.format(doc.get(0, doc.getLength()),impexDataDefinition);
			doc.set(formatted);

...
public class ImpexVariableRule implements IRule {
    ...
    public ImpexVariableRule(IToken token,ImpexDataDeffinition imexDataDef ){
    this(token);
    this.impexDataDeffinition=imexDataDef;
}
    ...
    public IToken evaluateInternal(ImpexScanner scanner) {
            ...
            while( c != ICharacterScanner.EOF  ){
                    ...
                    if( m.matches()){
                    	...
                    	if((']'== c || ')'==c || '='==c || '['==c || '('==c  || ';'==c ||c=='\n' ||c=='\r' )){
                    		scanner.unread();
                    		impexDataDeffinition.addVariableDecalration(stream);
